...
function initialize() {
  ...
  var newChart = /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
      var data, year, muncipilaty, x, st, ChartData, chart;
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 2:
              data = _context2.sent;
              year = Object.values(data.dimension.Vuosi.category.label);
              muncipilaty = Object.values(data.dimension.Alue.category.label);
              x = data.value;
              st = x.map(String);
              console.log(data);
              console.log(_typeof(st[1]));
              console.log(_typeof(year[1]));
              ChartData = {
                labels: year,
                datasets: [{
                  name: "Koko suomi",
